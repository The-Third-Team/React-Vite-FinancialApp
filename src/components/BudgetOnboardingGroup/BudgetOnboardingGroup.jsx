...
export default function BudgetOnboardingGroup({budgetData, editBudgetData, categories, currentGroupIdx, createUserBudget, groupInfo, updateGroupIdx, updateStartOnboarding}) {
    ...
    // Determines which text is displayed on each onboarding slide
  ...
  return (
    ...
    <div className='flex flex-col items-center'>
        ...
        <div className='bottom-4 flex items-center justify-between w-[80%] mb-4'>
            <button className='flex justify-center items-center px-10 py-3 text-[#52AD9C]' onClick={() => currentGroupIdx > 0 ? handleShowPrev() : handleBackToLanding()}>
                <div className='text-[18px]'>
                    Back
                </div>
            </button>
            <button className='flex justify-center items-center px-10 py-3 bg-[#3C6B04] text-white rounded-lg' onClick={() => currentGroupIdx < 3 ? handleShowNext() : handleCreateBudget()}>
